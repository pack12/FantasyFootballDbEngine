...
def main():
    ...
    parser.add_argument("--position", choices=["RB", "WR", "ALL"], default="ALL",
    ...
    print(f"{'Rank':<5} {'Player':<25} {'Age':<5} {'Pos':<5} {'Team':<5} {'GP':<4} {'GM':<4} {'Rec':<5} "
          f"{'RecYds':<8} {'RecTD':<6} {'Rush':<6} {'RushYds':<8} {'RushTD':<7} {'Fum':<5} "
          f"{'Points':<8} {'Pts/G':<7} {hist_header}")
    print("-" * (122 + (47 if args.history else 0)))
